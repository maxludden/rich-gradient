...
def description():
    ...
    gradient text, panels, rules, and spectrum utilities.",
            ...
            highlight_words={"rich-gradient": "bold #ddd", "rich": "bold #ddd"},
        ),
        justify="center",
    )
    console.line()
...
def quick_example_gradient_text():
    ...
    console.line()
    console.print(Text("    Hello, [b]world[/b]!", colors=["#f00", "#f90", "#FF0"]))
    console.line()
    console.save_svg(
...
def quick_start_rainbow_text():
    ...
    console.line()
    console.print(Text("    All the colors of the rainbow!", rainbow=True))
    console.line()
    console.save_svg(
...
def quick_start_gradient_panel():
    ...
    console.line()
    console.print(Panel("Gradient Panel content...", title="Panel Title"))
    console.line()
    console.save_svg(
