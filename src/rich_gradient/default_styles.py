...
DEFAULT_STYLES: dict[str, StyleType] = {
    ...
    "bg_style.white": Style(color="#111111", bgcolor="#ffffff", bold=True),
    ...
    "bg_style.lightgrey": Style(color="#111111", bgcolor="#dddddd", bold=True),
    ...
    "bg_style.lightgray": Style(color="#111111", bgcolor="#dddddd", bold=True),
    ...
    "bg_style.grey": Style(color="#111111", bgcolor="#888888", bold=True),
    ...
    "bg_style.gray": Style(color="#111111", bgcolor="#888888", bold=True),
    ...
    "bg_style.pink": Style(color="#111111", bgcolor="#ff00af", bold=True),
    ...
    "bg_style.deeppink": Style(color="#111111", bgcolor="#ff1493", bold=True),
    ...
    "bg_style.red": Style(color="#111111", bgcolor="#ff0000", bold=True),
    ...
    "bg_style.tomato": Style(color="#111111", bgcolor="#FF4B00", bold=True),
    ...
    "bg_style.darkorange": Style(color="#111111", bgcolor="#FF8700", bold=True),
    ...
    "bg_style.orange": Style(color="#111111", bgcolor="#FFAF00", bold=True),
    ...
    "bg_style.yellow": Style(color="#111111", bgcolor="#ffff00", bold=True),
    ...
    "bg_style.greenyellow": Style(color="#111111", bgcolor="#adff2f", bold=True),
    ...
    "bg_style.green": Style(color="#111111", bgcolor="#7CFF00", bold=True),
    ...
    "bg_style.lime": Style(color="#111111", bgcolor="#00ff00", bold=True),
    "springgreen": Style(color="#00FA9A"),
    "bold.springgreen": Style(color="#00FA9A", bold=True),
    "repr.springgreen": Style(color="#00FA9A", bold=True),
    "cs.springgreen": Style(color="#00FA9A", bgcolor="default", bold=True),
    "style.springgreen": Style(color="#00FA9A", bgcolor="default", bold=True),
    "bg_style.springgreen": Style(color="#111111", bgcolor="#00FA9A", bold=True),
    ...
    "bg_style.cyan": Style(color="#111111", bgcolor="#00ffff", bold=True),
    ...
    "bg_style.lightblue": Style(color="#111111", bgcolor="#00C3FF", bold=True),
    ...
    "bg_style.skyblue": Style(color="#111111", bgcolor="#0087FF", bold=True),
    ...
    "bg_style.violet": Style(color="#111111", bgcolor="#5F00FF", bold=True),
    ...
    "bg_style.purple": Style(color="#111111", bgcolor="#AF00FF", bold=True),
