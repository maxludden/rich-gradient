    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            auto_refresh=auto_refresh or True,
            refresh_per_second=refresh_per_second or 30.0,
            console=console or Console(),
            transient=transient or False,
            redirect_stdout=redirect_stdout or False,
            redirect_stderr=redirect_stderr or False,
            disable=disable or False,
            expand=expand or True,
            justify=justify or "left",
            vertical_justify=vertical_justify or "top",
            hues=hues or 5,
            rainbow=rainbow or False,
            phase_per_second=phase_per_second or 0.12,
            speed=speed or 10,
            repeat_scale=repeat_scale or 4.0,
            highlight_words=highlight_words or None,
            highlight_regex=highlight_regex or None,
