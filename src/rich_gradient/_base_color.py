...
class BaseColor:
    ...
    **An edited version of the `Color` class from the [`pydantic-extra-types`](https://github.com/pydantic/pydantic-extra-types) package.*
    ...
    def __init__(self, value: ColorType) -> None:
        ...
        elif isinstance(value, BaseColor):
    ...
    def original(self) -> ColorType:
        """Original value passed to `BaseColor`."""
    ...
    @classmethod
    def _validate(cls, __input_value: Any, _: Any) -> BaseColor:
    ...
    def __eq__(self, other: Any) -> bool:
        return (
            isinstance(other, BaseColor) and self.as_rgb_tuple() == other.as_rgb_tuple()
        )
